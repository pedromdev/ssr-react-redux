...
var _listUsers = __webpack_require__(13);
...
exports.default = [{
    ...
    loadData: _listUsers.loadData,
    path: '/users',
    component: _listUsers2.default
}];
...
app.get("*", function (req, res) {
    ...
    var promices = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (_ref) {
